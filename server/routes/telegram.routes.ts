...
/**
 * Representa el ingreso confirmado por Telegram mediante un invite link.
 */
type EventoInviteUsado = {
  /** Link privado reportado por Telegram como origen del ingreso. */
  inviteLink: string;
  /** ID de Telegram del usuario que ingresó. */
  telegramUserId?: string | number | null;
  /** Username de Telegram del usuario que ingresó. */
 ...
 */
function extraerInviteUsado(update: any): EventoInviteUsado | null {
 ...
 */
function validarSecretoTelegram(req: any): boolean {
...
router.post("/webhook", async (req: any, res) => {
  ...
  try {
    ...
    await marcarInviteVipComoUsado(
      inviteUsado.inviteLink,
      inviteUsado.telegramUserId,
      inviteUsado.telegramUsername
    );
