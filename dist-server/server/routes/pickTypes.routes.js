...
router.put("/:id", authenticateToken, requireAdmin, async (req, res) => {
    ...
    try {
        ...
        const [filasActuales] = await pool.query("SELECT id, name, telegram_channel_id, telegram_invite_link FROM pick_types WHERE id = ?", [id]);
        ...
        const [result] = await pool.query("UPDATE pick_types SET name = ?, telegram_channel_id = ?, telegram_invite_link = ? WHERE id = ?", [nombreFinal, canalFinal, enlaceFinal, id]);
...
router.post("/:id/test-telegram", authenticateToken, requireAdmin, async (req, res) => {
    ...
    try {
        ...
        const [filas] = await pool.query("SELECT name, telegram_channel_id FROM pick_types WHERE id = ?", [id]);
